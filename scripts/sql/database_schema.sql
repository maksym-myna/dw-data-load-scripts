...
DELETE FROM pfp WHERE user_id != 0;
DELETE FROM library_user WHERE user_id != 0;

-- DROP DOMAIN IF EXISTS EMAIL_DOMAIN CASCADE;
-- DROP DOMAIN IF EXISTS gender_domain CASCADE;
-- DROP DOMAIN IF EXISTS USER_ROLE_DOMAIN CASCADE;

DROP PROCEDURE IF EXISTS insert_work_and_subject(TEXT, TEXT, TEXT, TEXT, INT, NUMERIC, INT, TEXT, INT, TEXT);

CREATE EXTENSION IF NOT EXISTS citext;
CREATE EXTENSION IF NOT EXISTS pg_trgm;

DROP TYPE IF EXISTS ITEM_MEDIUM_TYPE CASCADE;
DROP TYPE IF EXISTS READING_STATUS_TYPE CASCADE;
